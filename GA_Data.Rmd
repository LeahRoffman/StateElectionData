...
write_csv(state_senate_key, "../Exports/GA_SenDistricts_Key.csv")

# State Representative Districts
write_csv(state_house_key, "../Exports/GA_RepDistricts_Key.csv")


# Congressional representative districts 
write_csv(state_congress_key, "../Exports/GA_CongressDistricts_Key.csv")

#  District Attorney districts 
write_csv(state_district_key, "../Exports/GA_AttorneyCircuitDistricts_Key.csv")

# All GA counties 
write_csv(data.frame(County_name = unique(for_export$County_name)), "../Exports/GA_County_List.csv")
...
```{r}
# Number of unique contests in Catoosa 
wider %>% filter(County_name == "CATOOSA") %>% select(Contest_name, Has_Dem, Has_Rep) %>% count(Has_Dem, Has_Rep)

wider %>% filter(County_name == "CATOOSA") %>% filter(Has_Dem==0, Has_Rep==1)
```
